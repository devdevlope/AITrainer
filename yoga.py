...
cap = cv2.VideoCapture("warrior pose.mp4")
bTime = 0
...
while True:
    ...
    if len(lmList) != 0:
        ...
        if z == 1:
            ...
            per_arm_r = np.interp(arm_r, (170, 195), (0, 100))
            per_arm_l = np.interp(arm_l, (170, 195), (0, 100))
            per_upbody_r = np.interp(upbody_r, (90, 110), (0, 100))
            per_upbody_l = np.interp(upbody_l, (260, 280), (100, 0))
            per_knee_r = np.interp(knee_r, (100, 125), (100, 0))
            per_knee_l = np.interp(knee_l, (170, 190), (0, 100))

            if (per_arm_r > 10 and per_arm_l > 10 and per_upbody_r > 10 and per_upbody_l > 10 and
                    per_knee_r > 10 and per_knee_l > 10):
                # h, w, c = overlayList[2].shape
        ...
        # Tree pose
            ...
            per_upbody_r = np.interp(upbody_r, (45, 70), (100, 0))
